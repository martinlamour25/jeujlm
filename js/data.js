...
const CARDS = {
  ...
  /* ---------- ÉVÉNEMENTS (crises imprévues scénarisées : à toi de réagir) ---------- */
  ev_cnews: {
    event: true, hits: "p", char: "cnews", scene: "studio_tv", tag: "p",
    text: "⚡ MINUIT. Sur la chaîne du milliardaire, un « édito spécial » répète ton nom entre deux nappes de musique anxiogène. À l'aube, la France a peur — de toi.",
    left: { label: "T'expliquer chez eux", fx: { p: -11 },
      result: "Sur leur plateau, tu joues leur match : coupé, caricaturé, noyé.",
      note: "Entrer dans l'arène de l'adversaire, c'est déjà perdre la mise.",
      quip: "Le bandeau rouge a gagné le débat.", head: "L'ÉDITO DE MINUIT" },
    right: { label: "Parler direct au peuple", fx: { p: -4, s: -3 },
      result: "Tu shuntes les plateaux : allocution, directs de terrain, vidéos virales. Énergie et moyens dépensés, mais c'est TOI qui parles.",
      note: "La bataille culturelle se mène au contact, pas dans leur studio.",
      quip: "Pendant qu'ils hurlent, toi tu expliques.", head: "PAR-DESSUS LES MÉDIAS" }
  },
  ev_hanouna: {
    event: true, hits: "p", char: "hanouna", scene: "studio_tv", tag: "p",
    text: "⚡ 20H45. « Touche pas à mon palais ! » On t'a réservé un fauteuil entre douze chroniqueurs déchaînés et un applaudimètre réglé contre toi.",
    left: { label: "Entrer dans l'arène", fx: { p: -11 },
      result: "Le clash fait de l'audience ; du fond, personne n'en parle.",
      note: "La télé-poubelle transforme le débat en spectacle vide.",
      quip: "Standing ovation du public chauffé à blanc.", head: "PRIME TIME ASSASSIN" },
    right: { label: "Snober le cirque", fx: { p: -4, s: -3 },
      result: "Tu déclines et finances un grand service public de l'info. Long à payer, mais digne.",
      note: "Une information libre vaut mieux que l'audimat du clash.",
  ...
  ev_bollore: {
    ...
    text: "⚡ OPA. L'empire Bolloré rafle trois titres de plus. Bientôt, toutes les « Unes » de France penseront d'une seule voix : la sienne.",
    left: { label: "Laisser l'empire grandir", fx: { p: -10, v: -3 },
      ...
      quip: "La pluralité d'opinions, version actionnaire unique.", head: "L'EMPIRE AVALE TOUT" },
    right: { label: "Loi anti-monopole express", fx: { p: -3, s: -4 },
      result: "Tu dégaines une loi anti-concentration. Bataille juridique coûteuse, mais l'info respire.",
  ...
  ev_extreme_droite: {
    ...
    text: "⚡ Drapeaux et torches : l'extrême droite défile en masse, récupère la colère sociale et la retourne contre des boucs émissaires.",
    left: { label: "Condamner et attendre", fx: { p: -12, s: -3 },
    ...
    right: { label: "Répondre par le social", fx: { p: -4, s: -5 },
      result: "Pouvoir d'achat, services publics, fraternité : tu assèches le terreau de la haine.",
  ...
  ev_notation: {
    ...
    text: "⚡ 7H02. Trois lettres tombent : la France perd son AA. Les écrans de la City rougissent, les éditos convoquent l'apocalypse.",
    left: { label: "Donner des gages", fx: { v: -12, s: -3 },
      ...
      quip: "Trois lettres pour faire trembler un pays.", head: "LA FRANCE DÉGRADÉE" },
    right: { label: "Désobéir aux marchés", fx: { v: -5, s: -4 },
      result: "Tu ignores les agences et bloques la fuite des capitaux. Tempête immédiate, mais tu gardes la main.",
      note: "Protéger l'économie réelle des attaques spéculatives.",
      quip: "Les agences notent. Le peuple, lui, vote.", head: "LA FINANCE NE DICTE PAS" }
  },
  ev_speculation: {
    event: true, hits: "v", char: "lobby", scene: "bourse", tag: "v",
    text: "⚡ Les requins de la finance parient des milliards CONTRE la France. Les taux s'envolent, la dette devient un piège.",
    left: { label: "Rassurer la Bourse", fx: { v: -10, s: -2 },
      result: "Tu multiplies les gages pour calmer la Bourse… qui en redemandera.",
    ...
    right: { label: "Pôle bancaire public", fx: { v: -4, s: -5 },
      result: "Tu adosses l'économie réelle à un pôle public. Lourd à lancer, mais la spéculation cale.",
      note: "Mettre la finance au service de l'intérêt général.",
  ...
  ev_canicule: {
    ...
    text: "⚡ 47 °C À L'OMBRE. Le bitume fond, les forêts s'embrasent, les hôpitaux débordent. La planète envoie sa facture.",
    left: { label: "Climatiseurs pour tous", fx: { e: -12, s: -2 },
      result: "On climatise à tout-va sans rien changer. La prochaine canicule sera pire.",
      note: "Sans planification, chaque crise climatique en aggrave une autre.",
      quip: "On éteint l'incendie à l'essence. Brillant.", head: "LE SUD EN FEU" },
    right: { label: "Plan d'adaptation choc", fx: { e: -5, s: -4 },
      result: "Rénovation, reforestation, gestion de l'eau : tu armes le pays contre la fournaise. Cher, mais durable.",
      note: "Anticiper et planifier protège d'abord les plus fragiles.",
  ...
  ev_inondations: {
    ...
    text: "⚡ Des trombes d'eau engloutissent des villes. Familles sur les toits, hélicos en vol : le climat cogne, encore.",
    left: { label: "Rebâtir à l'identique", fx: { e: -10, s: -3 },
      result: "On reconstruit dans le lit du fleuve… jusqu'à la prochaine crue.",
      note: "Reconstruire sans changer, c'est préparer la catastrophe suivante.",
      quip: "Le béton gagne, la rivière reviendra.", head: "LES VILLES SOUS L'EAU" },
    right: { label: "Reconstruire et renaturer", fx: { e: -4, s: -5 },
      result: "Tu désartificialises, restaures les zones humides, relocalises l'habitat. Coûteux, mais on cesse de jouer avec l'eau.",
      note: "Faire de l'eau et du vivant des biens communs à protéger.",
      quip: "La nature reprend ses droits, pas le béton.", head: "RECONSTRUIRE AUTREMENT" }
  },
  ev_secheresse: {
    event: true, hits: "e", char: "farmer", scene: "champ", tag: "e",
    text: "⚡ Six mois sans pluie. Nappes à sec, récoltes grillées, méga-bassines sous tension : à qui l'eau qui reste ?",
    left: { label: "Servir les gros d'abord", fx: { e: -10, s: -3 },
      result: "L'eau part à l'agro-industrie, les conflits d'usage explosent.",
      note: "L'eau accaparée par quelques-uns, c'est la guerre de tous.",
      quip: "Les méga-bassines n'ont rempli que les profits.", head: "LA GUERRE DE L'EAU" },
    right: { label: "Eau bien commun", fx: { e: -4, s: -5 },
      result: "Rationnement équitable, soutien aux paysans, fin de l'accaparement. Cher pour les caisses, juste pour tous.",
  ...
  ev_greve_patronale: {
    ...
    left: { label: "Lâcher du lest", fx: { s: -10 },
      result: "Tu recules sur tes réformes pour amadouer le capital. Il en redemandera.",
    ...
    right: { label: "Relance publique", fx: { s: -4, v: -4 },
      result: "Investissement public, droit de veto des salariés : pas d'argent privé ? L'État avance.",
      note: "Répondre au chantage par la maîtrise publique et les droits des salariés.",
      quip: "Grève du patronat ? Le peuple bosse quand même.", head: "L'ÉTAT NE PLIE PAS" }
  },
  ev_delocalisation: {
    ...
    left: { label: "Laisser faire le marché", fx: { s: -11 },
      result: "L'usine ferme, la ville s'effondre, le bassin d'emploi meurt.",
      note: "Sans pouvoir d'intervention, les salariés subissent les choix des actionnaires.",
      quip: "Le patron prend l'avion, la ville prend le deuil.", head: "L'USINE FERME" },
    right: { label: "Réquisition en coopérative", fx: { s: -4, v: -4 },
      result: "Les salariés reprennent l'outil en SCOP, soutenus par l'État. Bras de fer, mais l'emploi reste.",
      note: "Donner aux salariés un droit de reprise sur leur entreprise.",
      quip: "L'usine au peuple, pas aux fonds de pension.", head: "L'USINE SAUVÉE" }
  },
  ev_pandemie: {
    event: true, hits: "s", char: "nurse", scene: "hopital", tag: "s",
    text: "⚡ ALERTE OMS. Un nouveau virus circule. 2020 ressurgit : masques, lits, impréparation… L'histoire va-t-elle bégayer ?",
    left: { label: "Compter sur le privé", fx: { s: -11 },
      result: "On court après les masques et les lits. Le marché ne suit pas, les patients trinquent.",
      note: "La santé livrée au marché, c'est l'impréparation organisée.",
      quip: "Les stocks stratégiques ? Bradés avant toi.", head: "L'IMPRÉPARATION" },
    right: { label: "Hôpital public + Sécu", fx: { s: -4, v: -3 },
      result: "Réquisition de production, lits rouverts, gratuité des soins : l'État protège, sans profiteurs.",
      note: "Un service public de santé fort est la meilleure assurance collective.",
      quip: "La santé n'a pas de prix — elle a un budget public.", head: "L'ÉTAT PROTECTEUR" }
  },
  ev_cyber: {
    event: true, hits: "v", char: "tech", scene: "numerique", tag: "v",
    text: "⚡ 03H17. Une cyberattaque paralyse hôpitaux, impôts et trains. Une rançon clignote en bitcoins : quelqu'un tient le pays en otage.",
    left: { label: "Payer la rançon", fx: { v: -10, s: -3 },
      result: "Tu paies pour rétablir le service. Le précédent est posé : ils reviendront.",
      note: "Sans souveraineté numérique, on dépend du bon vouloir des pirates.",
      quip: "On paie les pirates ? Ils reviendront dîner.", head: "PAYS PIRATÉ" },
    right: { label: "Souveraineté numérique", fx: { v: -5, s: -4 },
      result: "Tu réquisitionnes les ingénieurs, bascules en logiciel libre et reconstruis en public. Douloureux, mais souverain.",
      note: "Reprendre la maîtrise publique des infrastructures numériques.",
      quip: "Le cloud sera désormais public et français.", head: "REPRISE EN MAIN" }
  },
  ev_bruxelles: {
    event: true, hits: "v", char: "eu", scene: "ue", tag: "v",
    text: "⚡ BRUXELLES. La Commission attaque ta loi sociale devant la Cour : « entrave à la concurrence ». Menace d'amendes colossales.",
    left: { label: "Retirer la loi", fx: { v: -10, s: -4 },
      result: "Tu plies devant la Cour. Le social recule, « concurrence » oblige.",
      note: "Les traités servent trop souvent à interdire le progrès social.",
      quip: "La concurrence libre… et le social tiré vers le bas.", head: "BRUXELLES DICTE SA LOI" },
    right: { label: "Désobéir (Plan B)", fx: { v: -4, s: -3 },
      result: "Tu invoques la clause de non-régression et maintiens la loi. Bras de fer ouvert avec Bruxelles.",
  ...
  ev_emeutes: {
    ...
    text: "⚡ Une bavure de trop. Des quartiers s'embrasent, la colère déborde, les chaînes tournent en boucle sur les flammes.",
    left: { label: "Couvre-feu et blindés", fx: { p: -12, v: -3 },
      result: "La répression militarise la rue. La plaie s'infecte au lieu de guérir.",
      note: "L'ordre par la peur n'a jamais réglé une fracture sociale.",
      quip: "L'ordre par la matraque n'a jamais soigné une plaie.", head: "L'ENGRENAGE SÉCURITAIRE" },
    right: { label: "Justice + quartiers", fx: { p: -5, s: -4 },
      result: "Tu sanctionnes la bavure, ouvres le dialogue, réarmes les services publics abandonnés.",
      note: "Répondre par la justice et l'égalité réelle, partout sur le territoire.",
      quip: "La République, c'est l'égalité — partout.", head: "RÉPONDRE PAR LA JUSTICE" }
  },
  ev_scandale: {
    event: true, hits: "p", char: "judge", scene: "palais", tag: "p",
    text: "⚡ « LEAKS ». Un fichier fuite : de grandes fortunes — et quelques amis du pouvoir — planquent des milliards aux Caïmans.",
    left: { label: "Minimiser l'affaire", fx: { p: -10 },
      result: "Tu temporises, l'affaire est enterrée. La défiance, elle, explose.",
      note: "Étouffer la corruption, c'est la nourrir.",
      quip: "« Circulez » : le pire des aveux.", head: "L'AFFAIRE ÉTOUFFÉE" },
    right: { label: "Justice fiscale implacable", fx: { p: -3, v: -4 },
      result: "Enquêtes, saisies, inéligibilités. Les fortunes hurlent et menacent de fuir — qu'elles fuient.",
      note: "Inéligibilité à vie, lutte contre l'évasion : une République exemplaire.",
      quip: "Les Caïmans, c'est fini.", head: "JUSTICE FISCALE" }
  },
  ev_gilets: {
    event: true, hits: "p", char: "citizen", scene: "manif", tag: "p",
    text: "⚡ Sur les ronds-points, des milliers de gilets : carburant en feu, fin du mois impossible. La colère est juste — on tente de la retourner contre toi.",
    left: { label: "Taxer sans compenser", fx: { p: -10, s: -3 },
      result: "Une taxe qui tombe sur les plus modestes : l'étincelle de trop.",
      note: "Pas de transition juste sans justice sociale.",
      quip: "Une taxe sans justice, c'est une étincelle.", head: "LA COLÈRE DES RONDS-POINTS" },
    right: { label: "Bouclier prix + transports gratuits", fx: { p: -4, s: -4 },
      result: "Blocage des prix de l'essentiel, transports publics gratuits, assemblée citoyenne.",
      note: "Répondre à la colère sociale par le concret et la démocratie directe.",
      quip: "À la colère, on répond par l'égalité — pas la matraque.", head: "LE BOUCLIER POPULAIRE" }
  },
  ev_marronnier: {
    event: true, hits: "p", char: "cnews", scene: "studio_tv", tag: "p",
    text: "⚡ Tu présentes une grande loi de partage des richesses… et toutes les chaînes ne parlent que d'un fait divers. Diversion bien huilée.",
    left: { label: "Courir après le buzz", fx: { p: -8, s: -2 },
      result: "Tu cours derrière le fait divers ; le partage des richesses passe à la trappe.",
    ...
    right: { label: "Tenir le cap du réel", fx: { p: -3, s: -3 },
      result: "Tu ramènes le débat sur les salaires, l'hôpital, la Sécu. Moins spectaculaire, plus utile.",
